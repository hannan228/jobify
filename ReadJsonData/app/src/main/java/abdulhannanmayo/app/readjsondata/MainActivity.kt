package abdulhannanmayo.app.readjsondata
...
class MainActivity : AppCompatActivity() {
    ...
    fun saveRecord(view: View){
        val id1 = findViewById<TextView>(R.id.u_id)
        val name1 = findViewById<TextView>(R.id.u_name)
        val email1 = findViewById<TextView>(R.id.u_email)
